...
load_dir = Path("C:\\Temp\\seqTransit")
#Read relevant GTFS tables to pandas dataframes
stops = pd.read_csv(Path.joinpath(load_dir, 'stops.txt'))
shapes = pd.read_csv(Path.joinpath(load_dir, 'shapes.txt'))
routes = pd.read_csv(Path.joinpath(load_dir, 'routes.txt'))
stop_times = pd.read_csv(Path.joinpath(load_dir, 'stop_times.txt'))
trips = pd.read_csv(Path.joinpath(load_dir, 'trips.txt'))
...
with open(Path.joinpath(load_dir, 'route_shapes.geojson'), 'w') as outfile:
